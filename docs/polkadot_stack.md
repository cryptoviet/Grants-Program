...
| Burner Wallets/Faucet| [KodaDot](https://github.com/vue-polkadot/apps) :yellow_circle:, [Astar Faucet Bot](https://github.com/AstarNetwork/astar-faucet-bot) :red_circle:| Faucet (a sybil-resistant way to receive free tokens)
...
| Block Explorers | [Polkaholic](https://github.com/colorfulnotion/polkaholic) :green_circle:, [Polkascan](https://github.com/polkascan/explorer-api) :yellow_circle:, [Polkastats](https://github.com/Colm3na/polkastats-backend) :red_circle:, [Subscan](https://github.com/itering/subscan) :yellow_circle:, [Statescan](https://github.com/opensquare-network/statescan) :green_circle:, [Edgscan](https://github.com/edgeware-builders/edgscan) :red_circle:| Ink Smart Contract Explorer, Mempool focused explorer (including parachain transaction)
...
| Smart Contract Security | [Vanguard](https://github.com/Veridise/Vanguard) :yellow_circle:| 
...
| NFT | [ternoa](https://github.com/capsule-corp-ternoa/chain) :green_circle:, [FRAME Pallet: NFTs for Substrate](https://github.com/danforbes/pallet-nft) :red_circle:, [Unique NFT Parachain](https://github.com/UniqueNetwork/unique-chain) :red_circle:, [DNFT](https://github.com/DNFT-Team/dnft-substrate-node/tree/master/pallets) :red_circle:, [RMRK-Substrate](https://github.com/rmrk-team/rmrk-substrate) :green_circle:
